...
const Features = () => {
  ...
  return (
    <div
      ref={featuresRef}
      className="sticky top-0 pt-[18vh] features flex flex-col items-center mt-[3px] h-[150vh]"
      style={{ backgroundColor: "#FFC3A0", fontFamily: "Poppins, sans-serif" }}
    >
      <div className="featuresHeading flex items-center justify-center">
        <h1
          className="text-center font-display font-semibold text-[4rem]"
          style={{ color: "#000000" }}
        >
          What We Offer?
        </h1>
        ...
        >
          <div className="card-wrapper">
            <div className="flip-card-inner">
              <div
                ref={(el) => (frontElRefs.current[index] = el)}
              ...
              <div
                ref={(el) => (backElRefs.current[index] = el)}
                className="flip-card-back flex flex-col detail space-y-2"
              ...
              >
                ...
                <p className="text-justify text-[1rem]" style={{ color: "#4A4A4A" }}>
                  {feature.description}
                </p>
              </div>
            </div>
